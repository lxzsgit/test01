...
import re
#
# print("请在手机开发者选项中将“GPU呈现模式分析”更改为在“adb shell dumpsys gfxinfo呈现”")
# appPkg = 'com.excelliance.dualaid'
# d = input("操作完毕请输入Y/y")
# if d == 'Y' or 'y':
#     os.popen('adb shell force-stop ' + appPkg)
#     print('请操作要测试的应用')
#
#
#     text = os.popen('adb shell dumpsys gfxinfo' + appPkg).read()
#     g = re.search(r'Draw.View', text)
#
